...
public class LogClass implements Runnable {
    ...
    public LogClass(EmpresaLogistica empresa, long tiempoInicio) {
    ...
    public void run() {
        try { //lo ejecuto asi por el join
            ...
            while (ejecutandose) {
                int fallidos = empresa.getRegistrosPedidos().getCantidadFallidos(); //Se puede Reeemplazar ambos por unos metodos
                int verificados = empresa.getRegistrosPedidos().getCantidadVerificados();//que de la cantidad de verificados y fallidos de las listas que se ejecutan en los propios procesos
    ...
    private void imprimirEstadisticasCasilleros()  {
        ...
        //Leer parte de abajo
        Casillero[][] matriz = empresa.getCasilleros();
